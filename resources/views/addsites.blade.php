            ...
            <div class="grid md:grid-cols-3 gap-6 mx-6 my-6">
                ...
                <div>
                    ...
                    <select class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                        ...
                        <option {{ isset($site->exchange) == 'link insertion' ? 'selected' : '' }}
                            value="link insertion">
                            @lang('lang.Link_Insertion')
                        </option>
                        <option {{ isset($site->exchange) == 'guest post' ? 'selected' : '' }} value="guest post">
                            @lang('lang.Guest_Post')</option>
                        <option {{ isset($site->exchange) == 'both' ? 'selected' : '' }} value="both">
                            @lang('lang.Both')
                        </option>
                    </select>
                </div>
