...
<head>
    ...
    <title>Login - CubicExp</title>
    <link rel="shortcut icon" href="{{ asset('images/favicon(32X32).png') }}" type="image/x-icon">
    <link rel="stylesheet" href="{{ asset('css/style.css') }}">
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>

<body class="bg-white flex justify-center items-center h-[100vh]">
    <div class="w-[80%] h-[80vh] shadow-dark rounded-2xl relative">
        <div class="flex px-10 justify-center">
            ...
            <!-- image -->
            <div class="  w-1/2   h-[80vh] hidden md:flex items-center  ">
                <div class="h-[98%] w-full bg-slate-500 rounded-2xl flex justify-center align-items-center">
