                    ...
                    <table id="datatable">
                        <thead class="py-1 bg-primary text-white">
                            <tr>
                                ...
                                <th class="whitespace-nowrap text-sm">Invoice From</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($sendInvoice as $Invoice)
                                <tr>
                                    ...
                                    <td>{!! optional(\App\Models\User::find($Invoice->user_id))->name ??
                                        '<span class="text-red-600">Deleted User</span>' !!}</td>
                                    ...
                                    <td>
                                        <div class="flex gap-3 items-center justify-center">
                                            ...
                                            <a class="w-[42px] md:w-full"
                                                href="../delSendIvoice/{{ $Invoice->id }}"><svg width="36"
